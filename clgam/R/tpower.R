...
#'
#' It constructs a p-th degree truncated power function along a (numerical) vector within the function \code{bspline}. This is an internal function of the package \code{clgam} used for the construction of a B-spline basis.
#'
